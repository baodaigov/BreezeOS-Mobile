...
import { displayLowBatteryMenu } from '../../store/reducers/modal';
import { toggleBatterySaver } from '../../store/reducers/settings';
import { useEffect } from 'react';

export default function LowBattery(){
    const dispatch = useAppDispatch();
    const modal = useAppSelector(state => state.modal.lowbattery);
